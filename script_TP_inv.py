# -*- coding: utf-8 -*-
"""
Created on Thu Oct 15 14:05:42 2020
...
MLO_obs = np.loadtxt('MLO_obs.txt')
...
MLO_mod = np.loadtxt('MLO_mod.txt')
...
plt.savefig('GlobEm.eps', dpi=200)
plt.show()
...
plt.savefig('RegEm.eps', dpi=200)
plt.show()

plt.plot(yrs,em_Amérique_b, color='blue')
plt.plot(yrs,em_Af_b, color='green')
plt.plot(yrs,em_AsieT_b, color='yellow')
plt.plot(yrs,em_AsN_b, color='red')
plt.plot(yrs,em_eu_b, color='purple')
plt.show()
...
#plt.plot(yrs,glob_ij_b)
plt.savefig('GlobEmInventaire.eps', dpi=200)
plt.show()
